...
Route::middleware(['web', 'auth', 'impersonate'])->group(function () {
    Route::get('/dashboard/{lang?}', [App\Http\Controllers\DashboardController::class, 'dashboard'])->middleware('isOwnerOnPro')->name('dashboard');
    Route::get('/home/{lang?}', [App\Http\Controllers\DashboardController::class, 'dashboard'])->middleware('isOwnerOnPro')->name('home');
