                        ...
                        <div class="card shadow">
                            ...
                            <div class="card-footer py-4">
                                ...
                                <div id="button-container-plan-{{$plan['id']}}"></div>
                                    ...
                                    @if(strlen($plan['stripe_id'])>2&&strtolower(config('settings.subscription_processor'))=='stripe')
...
@if (strtolower(config('settings.subscription_processor')) == "stripe")
<!-- Stripe -->
...
<script>
  ...
  var ENABLE_STRIPE="{{ strtolower(config('settings.subscription_processor'))=='stripe' }}";
  if(ENABLE_STRIPE){
